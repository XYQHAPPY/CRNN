...
parser.add_argument('--trainroot',  type=str,default='./data/nlp_sentiment_train_lmdb', help='path to dataset')
parser.add_argument('--valroot',  type=str, default='./data/nlp_sentiment_val_lmdb',help='path to dataset')
...
parser.add_argument('--experiment', type=str,default='./mymodels_nlp_sentiment/', help='Where to store samples and models')
parser.add_argument('--displayInterval', type=int, default=10, help='Interval to be displayed')
parser.add_argument('--n_test_disp', type=int, default=10, help='Number of samples to display when test')
parser.add_argument('--valInterval', type=int, default=25, help='Interval to be displayed')
parser.add_argument('--saveInterval', type=int, default=25, help='Interval to be displayed')
